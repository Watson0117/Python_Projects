...
#imported moduels\/ ---un comment when othor py files made
...
def load_gui(self):# below defines the tkinter widgets and the placment with the grid
    ...
    #below we difin the listbox and scroll bar
