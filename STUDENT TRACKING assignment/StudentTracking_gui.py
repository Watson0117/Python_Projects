...
def load_gui(self):
    ...
    self.lbl_courses = tk.Label(self.master,text='Current courses:')
    self.lbl_courses.grid(row=8,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    ...
    self.txt_courses = tk.Entry(self.master,text='')
    self.txt_courses.grid(row=9,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)
