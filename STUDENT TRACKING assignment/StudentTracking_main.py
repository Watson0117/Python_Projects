...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.master.title("The Tkinter StudentTracking page")
        ...
        helpmenu.add_separator()
        helpmenu.add_command(label="About StudentTracking") # add_command is a child menubar item of the add_cascde parent item
